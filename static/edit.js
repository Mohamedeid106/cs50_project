document.addEventListener('DOMContentLoaded', () => {
    ...
    let titles = document.querySelectorAll(".container-2 h3");
    ...
    const enableDarkMode = () => {
      ...
      document.querySelector(".container-2 form input[type='file']").style.color = "#ffffff";
      document.querySelector(".container-2 form input[type='text']").style.color = "#ffffff";
      document.querySelector(".container-2 form label").style.color = "#ffffff";
      btns.forEach((btn) => {
    ...
    const disableDarkMode = () => {
      ...
      document.querySelector(".container-2 form input[type='file']").style.color = "#484b6a";
      document.querySelector(".container-2 form input[type='text']").style.color = "#484b6a";
      document.querySelector(".container-2 form label").style.color = "#484b6a";
      btns.forEach((btn) => {
