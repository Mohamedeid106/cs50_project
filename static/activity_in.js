document.addEventListener('DOMContentLoaded', () => {
  ...
  let titles = document.querySelectorAll(".container-2 .concept h1");
  let concepts = document.querySelectorAll(".container-2 .concept p");
  let lists = document.querySelectorAll(".container-2 .concept ul li");
  ...
  const enableDarkMode = () => {
    ...
    concepts.forEach((concept) => {
      concept.style.color = "#d5d8ff";
    });
    lists.forEach((list) => {
      list.style.color = "#d5d8ff";
    });
  }
