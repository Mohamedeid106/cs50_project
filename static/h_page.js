document.addEventListener('DOMContentLoaded', () => {
  ...
  const enableDarkMode = () => {
    ...
    document.querySelector(".container-2").style.backgroundColor = "rgba(255,255,255,0.13)";
    ...
    document.querySelector(".container-2 .content .top-bar p").style.color = "#ffffff";
    document.querySelector(".container-2 .content .top-bar input").style.color = "#ffffff";
    document.querySelector(".container-2 .content .div-2 .calendar-wrapper").style.backgroundImage = "linear-gradient(0deg, #4E65FF, #92EFFD)";
  }
  ...
  const disableDarkMode = () => {
    ...
    document.querySelector(".container-2").style.backgroundColor = "#c7ccff71";
    ...
    document.querySelector(".container-2 .content .top-bar p").style.color = "#484b6a";
    document.querySelector(".container-2 .content .top-bar input").style.color = "#484b6a";
    document.querySelector(".container-2 .content .div-2 .calendar-wrapper").style.backgroundImage = "linear-gradient(180deg, #A9F1DF, #FFBBBB)";
  }
